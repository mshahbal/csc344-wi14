...
{   
  public static void main(String argv[]) {
	...
	{
	   int tick = 1, i = 0;
	   int randomNote, randomNum, plusOrMinus;
	   int notes[] = {50, 52, 53, 55, 57, 58, 61, 62};
...
//****  set all the notes!  ****
      while (tick < 6000) {
         randomNote = notes[rand.nextInt(8)];         
         ...
         if (i % 4 == 0) {
            ...
            for (int j=0; j < 4; j++)            
               randomNote = notes[rand.nextInt(8)] + (12 * plusOrMinus);
         }
